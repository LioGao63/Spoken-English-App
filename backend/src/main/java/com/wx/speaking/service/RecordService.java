...
public class RecordService {
     ...
     * 评测 WebAPI 调用示例程序
     */
    public String callApi(String category, String audioPath, String text) throws IOException {
        CATEGORY = category;
...
//        ResultController.resolveJson(result);
        String s = sentenceService.resolveSentenceJson(result);
        sentenceService.resolveSentenceJson(s);
        return s;
